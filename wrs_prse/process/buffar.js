var _bData = [
    ...
    { "exdz": false, "nam": ' أزالة علامات التكسير ', "ex": true, "eo": '[ّ|ً|ُ|ٍ|ِ|ُ|ْ|’|‘|َ|ُ|ٌ]' },
    ...
    { "exdz": false, "nam": ' تحويل الارقام العربية الى احرف أنجليزية ', "ex": false, "xvy": false, "eo":  [["٠", "0"], ["١", "1"], ["٢", "2"], ["٣", "3"], ["٤", "4"], ["٥", "5"], ["٦", "6"], ["٧", "7"], ["٨", "8"], ["٩", "9"]] },
    { "exdz": false, "nam": ' تحويل الارقام الانجليزية الى احرف عربية ', "ex": false, "xvy": false, "eo":  [["0","٠"], ["1","١"], ["2","٢"], ["3","٣"], ["4","٤"], ["5","٥"], ["6","٦"], ["7","٧"], ["8","٨"], ["9","٩"]] }
]
function bofpof(x) {
    if (x === true) {
        // meam get data
